...
$userData = mysqli_fetch_assoc($runGetUserData);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Seguidores de <?=$userData['firstName']?></title>
    <!-- css linked -->
    ...
    <div style="overflow:hidden" id="container">
        ...
        ?>
            ...
            <div id="details-online">
                <input type="text" id="user" value="<?=$id?>" hidden>

                <div class="divide">
                <img src="images/appyonline.png" class="onlineimg">
                <h1 id="announce">Seguidores</h1>
                </div>
        ...
        <!-- uses list -->
        <div style="overflow-y:scroll" id="onlineUsers">
            <!-- <a href="#">
                <div class="profile"> -->
                    <!-- profile image -->
                    <!-- <div class="image">
