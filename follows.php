...
<head>
    ...
    <title>Seguir Usuarios | Appy</title>
    <!-- css linked -->
    <link rel="stylesheet" href="css/followUsers.css">
...
<body>
    ...
    <div style="overflow:hidden" id="container">
		...
		<div style="overflow-y:scroll; padding-bottom:80px"  id="getUsers">
			<div id="onlineUsers"></div>

			<h1 id="announce" style="margin-top: 15px;display: flex;width: 100%;padding: 0 5%;">Recomendados</h1>
			<div id="recomendedUsers">
<!--
				<a href="#">
					<div class="profile">
-->
