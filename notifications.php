<?php
	...
	$notificaciones = "
		SELECT
			count(id) AS notifications_not_see
		FROM notifications
		WHERE id_user = {$_SESSION['id']} AND see = 0
	";
    $runCheckNoti = mysqli_query($conn, $notificaciones);
    $numNotificaciones = mysqli_fetch_assoc($runCheckNoti)["notifications_not_see"];
	...
	if (mysqli_num_rows($runCheckNoti) > 0) {
		...
		";
		$runMarkNotificationsAsRead = mysqli_query($conn, $markNotificationsAsRead);
	}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Tus notificaciones | Appy</title>
    <!-- css linked -->
    ...
    <div style="overflow:hidden" id="container">
        ...
        ?>
            ...
            <div id="details-online">
                ...
                <div class="divide">
                <img src="images/Iconos/ICONOS-05.png" class="onlineimg">
                <h1 id="announce">Notificaciones</h1>
                </div>
        ...
        <!-- uses list -->
        <div style="overflow-y:scroll; padding-bottom:80px" id="onlineUsers">
            <!-- <a href="#">
                <div class="profile"> -->
                    <!-- profile image -->
                    <!-- <div class="image">
